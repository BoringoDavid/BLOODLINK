...
# Customizing Django Admin interface for Blood Link System
admin.site.site_header = "BLOOD LINK ADMINISTRATION"
admin.site.site_title = "Blood Link Admin Portal"
admin.site.index_title = "Welcome to the BLOOD LINK Admin Panel"
