...
# forms.py in your app folder (create if not exists)
from django import forms
...
class TestimonialForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['story', 'role']
        widgets = {
            'story': forms.Textarea(attrs={'placeholder': 'Share your story...', 'rows': 4}),
            'role': forms.TextInput(attrs={'placeholder': 'e.g., Grateful Mother, Cancer Survivor'}),
        }
